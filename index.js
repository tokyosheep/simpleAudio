...
/* harmony export */   "initDataBaseEvent": () => /* binding */ initDataBaseEvent
/* harmony export */ });
...
var initDataBaseEvent = function initDataBaseEvent() {
  var strage = function () {
    try {
      return "".concat(app.getPath("appData"), "/database");
    } catch (e) {
      console.log(e);
    }
  }();
  ...
  var db = new DataStore({
    filename: "".concat(strage, "/data.db"),
    autoload: true
  });
  console.log(strage);
  ipcMain.handle("loadAllData", function (event) {
  ...
  ipcMain.handle("recoredAll", function (event, docs) {
    return new Promise(function (resolve, reject) {
      db.remove({}, {
        multi: true
      }, function (err) {
...
/* harmony import */ var _DataBase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DataBase */ "./main/DataBase.ts");
...
(0,_DataBase__WEBPACK_IMPORTED_MODULE_2__.initDataBaseEvent)();
